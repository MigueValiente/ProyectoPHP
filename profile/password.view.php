<form action="" method="POST" novalidate>
    <div class="form-group">
        ...
        <input type="password" class="form-control <?=($errores['current_password'])?"is-invalid":""?>" id="current_password" name="current_password" aria-describedby="passwordHelp" placeholder="Password">
    ...
    <div class="form-group">
        ...
        <input type="password" class="form-control <?=($errores['password'])?"is-invalid":""?>" id="password" name="password" aria-describedby="passwordHelp" placeholder="Password">
    ...
    <div class="form-group">
        ...
        <input type="password" class="form-control <?=($errores['passwordconf'])?"is-invalid":""?>" id="password-conf" name="password-conf" placeholder="Password">
